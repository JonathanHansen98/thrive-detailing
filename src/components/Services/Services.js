...
const Services = () => {
  ...
  return (
    <div>
      ...
      <div style={styles.container} className="w-100 d-flex justify-content-center">
        <Container className='px-5 py-5 mx-0'>
          <Row>
            ...
            <Col style={styles.lineSpaced}>
              ...
              <p>Thrive Detailing provides RV detailing near you and performs your RV detailing wherever you parked it! We're completely mobile and bring everything needed to do the detail on site including  water and  power! No matter if it’s a Class-A Motorhome, 5th wheel or travel trailer, our RV detailing pricing is straight forward. Simply select your RV's length and we will give you a price.</p>
            </Col>
          </Row>
          <Row>
            <Col>
